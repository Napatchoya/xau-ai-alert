...
if pattern_name in base_descriptions:
    ...
    return get_extended_pattern_descriptions().get(pattern_name, "ไม่มีข้อมูลแพทเทิร์นนี้")
...
⚠️ ความเสี่ยง: อาจ Oversold ระยะสั้น"""
    ...
    all_descriptions = {**base_descriptions, **extended_descriptions}
    
    return all_descriptions.get(pattern_name, "ไม่มีข้อมูลแพทเทิร์นนี้")
...
class AdvancedPatternDetector:
    ...
    def detect_existing_patterns(self, df):
        ...
        try:
            ...
            ascending_support = 2 + 0.2 * np.arange(len(highs))
